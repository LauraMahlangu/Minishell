...
#    Updated: 2017/09/29 12:40:26 by lmahlang         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
$(NAME): $(OBJ)
	...
	@clear
	@echo "Your minishell successfully compiled"
...
fclean: clean
	...
	make -C $(LIBFT) fclean
	@clear
	@echo "wow your  minishell is now clean"

re: fclean all
	@clear
	@echo "Congradulations Your minishell has been recompiled"
